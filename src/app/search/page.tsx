    ...
    return (
        <div className="min-h-screen bg-texture pb-20 body-pb-nav lg:pb-0">
            ...
            <main className="max-w-7xl mx-auto pt-24 lg:pt-20 px-4 sm:px-6 lg:px-8 pb-10">
                {!hasAccess ? (
                    /* Locked View */
                    <div className="text-center py-24 px-6 bg-[#fffdf9] rounded-sm border border-[#e8dfd1] shadow-md mb-12 max-w-2xl mx-auto relative overflow-hidden">
                        ...
                        <Link href="/upgrade" className="inline-flex items-center justify-center px-8 py-4 bg-[#3e2723] text-[#d4af37] font-bold rounded-sm shadow-md hover:bg-[#2a1a17] transition-colors border border-[#b8860b] tracking-widest text-sm transform hover:-translate-y-0.5">
                            <ShieldHalf className="w-5 h-5 mr-2" /> 契約を確認・変更する
                        </Link>
                    </div>
                ) : (
                    /* Search Content */
